...
namespace filament
{
    namespace math
    {
        ...
        public:
            ...
            TYPE bits{};
            static constexpr std::size_t getBitCount() noexcept { return S + E + M; }
 ...
 */
        ...
        template <>
        struct is_arithmetic<filament::math::half> : public std::true_type
        {
        };
...
namespace std
{
    ...
    template <>
    struct is_floating_point<filament::math::half> : public std::true_type
    {
    };
